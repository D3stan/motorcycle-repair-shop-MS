...
|----------|------|---------|------------
| PERSONA | E | 1 | L (CF uniqueness check)
| PERSONA | E | 1 | L (Email uniqueness check)
| PERSONA | E | 1 | S (Insert new cliente)
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| MOTO | E | 1 | L (NumTelaio uniqueness)
| MOTO | E | 1 | L (Targa uniqueness)
| MODELLO | E | 1 | L (Verify exists)
| PERSONA | E | 1 | L (Verify exists)
| MOTO | E | 1 | S (Insert motorcycle)
| REALIZZAZIONE | R | 1 | S (Link MODELLO to MOTO)
| POSSESSIONE | R | 1 | S (Link PERSONA to MOTO)
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| CLIENTE | E | 1 | L (Verify cliente exists)
| APPUNTAMENTO | E | 1 | S (Create appointment)
| CREAZIONE | R | 1 | S (Link CLIENTE to APPUNTAMENTO)
| APPUNTAMENTO | E | 1 | S (Update for confirmation/cancellation)

.center
    **Totale costo**: 6 letture -> 90 accessi al giorno
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| INTERVENTO | E | 1 | L (Verify exists and status)
| MECCANICO | E | 1 | L (Verify mechanic exists)
| SVOLGIMENTO | R | 1 | S (Create assignment)
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| RICAMBIO | E | 1200 | L (All parts for threshold check)
| STOCCAGGIO | R | 30 | L (All stock relationships)
| MAGAZZINO | E | 3 | L (All warehouses)
| FORNITORE | E | 25 | L (All suppliers for reorder info)
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| FORNITORE | E | 1 | L (Verify supplier)
| RICAMBIO | E | 1 | L (Verify part)
| FORNITURA | R | 1 | L (Get current supplier info)
| MAGAZZINO | E | 1 | L (Verify warehouse)
| STOCCAGGIO | R | 1 | L (Check existing stock)
| STOCCAGGIO | R | 1 | S (Update quantity)

.center
    **Totale costo**: 8 letture -> 16 accessi al giorno
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| INTERVENTO | E | 1 | L (Verify completed)
| EFFETTUAZIONE | R | 1 | L (Get MOTO from INTERVENTO)
| MOTO | E | 1 | L (Motorcycle details)
| REALIZZAZIONE | R | 1 | L (Get MODELLO from MOTO)
| MODELLO | E | 1 | L (Model details for invoice)
| POSSESSIONE | R | 1 | L (Get CLIENTE from MOTO)
| CLIENTE | E | 1 | L (Cliente details)
| UTILIZZO | R | 2.5 | L (Parts used - average)
| RICAMBIO | E | 2.5 | L (Part details and prices)
| FATTURA | E | 1 | S (Create invoice)
| EMISSIONE | R | 1 | S (Link LAVORO to FATTURA)
| INTESTAZIONE | R | 1 | S (Link FATTURA to CLIENTE)

.center
    **Totale costo**: 16 letture -> 1600 accessi al mese
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| APPUNTAMENTO | E | 50 | L (Upcoming appointments)
| INTERVENTO | E | 100 | L (Recent/active interventions)
| SESSIONE | E | 50 | L (Recent/active sessions)
| FATTURA | E | 100 | L (Recent invoices for revenue)
| RICAMBIO | E | 1200 | L (All parts for stock alerts)
| STOCCAGGIO | R | 30 | L (All stock quantities)
| MAGAZZINO | E | 3 | L (All warehouses)
...
|----------|------|---------|------------
| PERSONA | E | 1 | L (Verify exists)
| PERSONA | E | 1 | S (Update role/type)
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| MOTO | E | 1 | L (Get motorcycle details)
| EFFETTUAZIONE | R | 2.25 | L (Get all interventions)
| INTERVENTO | E | 2.25 | L (Intervention details)
| SVILUPPO | R | 0.75 | L (Get all sessions)
| SESSIONE | E | 0.75 | L (Session details)
| SVOLGIMENTO | R | 2.25 | L (Mechanics assigned to interventions)
| AFFIANCAMENTO | R | 4.5 | L (Mechanics assigned to sessions)
| PERSONA | E | 3 | L (Mechanic details)
| UTILIZZO | R | 5.6 | L (Parts used in interventions)
| RICAMBIO | E | 5.6 | L (Part details and costs)
...
| Concetto | Tipo | Accessi | Operazione 
|----------|------|---------|------------
| CLIENTE | E | 1 | L (Cliente verification)
| POSSESSIONE | R | 1 | L (Get motorcycle)
| MOTO | E | 1 | L (Motorcycle details)
| EFFETTUAZIONE | R | 1 | L (Get current intervention)
| INTERVENTO | E | 1 | L (Intervention status)
