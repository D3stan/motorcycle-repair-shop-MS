...
1. **Costo totale dei ricambi utilizzati in un intervento**: aggiungere l'attributo `CostoTotaleRicambi` alla tabella INTERVENTI per evitare di calcolare ogni volta la somma dei costi dei ricambi utilizzati.

2. **Quantità totale di ricambi disponibili**: aggiungere l'attributo `QuantitaTotale` alla tabella RICAMBI per evitare di sommare le quantità presenti in tutti i magazzini.

### RIDONDANZA 1 - Costo totale ricambi per intervento

#####! OP 7 - Generazione fattura per intervento completato (CON ridondanza)
Con l'aggiunta dell'attributo `CostoTotaleRicambi` nella tabella INTERVENTI, il calcolo del costo totale dei ricambi diventa immediato.
...
**Totale costo con ridondanza**: 12 letture -> 1200 accessi al mese

#####! OP 7 - Generazione fattura per intervento completato (SENZA ridondanza)
Senza la ridondanza, è necessario accedere alla tabella UTILIZZI per calcolare il costo totale dei ricambi.
...
**Totale costo senza ridondanza**: 18 letture -> 1800 accessi al mese

**Risparmio**: 600 accessi al mese

### RIDONDANZA 2 - Quantità totale ricambi disponibili

#####! OP 5 - Visualizzazione inventario con soglie di riordino (CON ridondanza)
Con l'aggiunta dell'attributo `QuantitaTotale` nella tabella RICAMBI, non è necessario sommare le quantità dei diversi magazzini.
...
**Totale costo con ridondanza**: 1225 letture -> 49000 accessi al mese

#####! OP 5 - Visualizzazione inventario con soglie di riordino (SENZA ridondanza)
...
**Totale costo senza ridondanza**: 1258 letture -> 50320 accessi al mese

**Risparmio**: 1320 accessi al mese

### Conclusioni

Le ridondanze offrono vantaggi significativi in termini di prestazioni, tuttavia introducono una leggera complessità di mantenimento dei dati. In aggiunta si perde parte della flessibilità desiderata.
